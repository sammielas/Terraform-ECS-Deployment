...
resource "aws_security_group" "data_migration_sg" {
  name        = "data-migration-sg"
  description = "Security group for data migration"
  ...
  ingress {
    ...
    to_port     = 3306
    protocol    = "tcp"
    cidr_blocks = ["0.0.0.0/0"] # Adjust as needed, be cautious with open access
  }
